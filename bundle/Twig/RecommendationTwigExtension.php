...
use EzSystems\Recommendation\Core\Exception\InvalidArgumentException;
...
class RecommendationTwigExtension extends Twig_Extension
{
     ...
     * @return string
     *
     * @throws \EzSystems\Recommendation\Core\Exception\InvalidArgumentException when attributes are missing
     */
