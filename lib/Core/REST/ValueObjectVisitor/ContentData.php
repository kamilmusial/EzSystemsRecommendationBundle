 ...
 */
namespace EzSystems\Recommendation\Core\REST\ValueObjectVisitor;

use eZ\Publish\Core\REST\Common\Output\ValueObjectVisitor;
use eZ\Publish\Core\REST\Common\Output\Generator;
use eZ\Publish\Core\REST\Common\Output\Visitor;
use EzSystems\Recommendation\Core\REST\Exception\ResponseClassNotImplementedException;
...
class ContentData extends ValueObjectVisitor
{
     ...
     * @param mixed $data
     * @return mixed
     * @throws \EzSystems\Recommendation\Core\REST\Exception\ResponseClassNotImplementedException
     */
